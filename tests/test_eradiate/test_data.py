...
def test_required_data_sets():
    ...
    assert data.find(category="thermoprops")["afgl_1986-tropical"]
    assert data.find(category="thermoprops")["afgl_1986-midlatitude_summer"]
    assert data.find(category="thermoprops")["afgl_1986-midlatitude_winter"]
    assert data.find(category="thermoprops")["afgl_1986-subarctic_summer"]
    assert data.find(category="thermoprops")["afgl_1986-subarctic_winter"]
    assert data.find(category="thermoprops")["afgl_1986-us_standard"]
