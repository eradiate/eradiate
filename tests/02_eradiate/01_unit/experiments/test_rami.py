...
def test_rami_experiment_construct_default(modes_all_double):
    """
...
def test_rami_experiment_construct_measures(mode_mono_double):
    """
...
def test_rami_experiment_construct_normalize_measures(mode_mono_double, padding):
    """
...
@pytest.mark.slow
def test_rami_experiment_real_life(modes_all_double):
    ctx = KernelDictContext()
...
@pytest.mark.slow
def test_rami_experiment_run_detailed(modes_all_double):
    """
