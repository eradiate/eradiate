...
# ------------------------------------------------------------------------------
# Rewrite exceptions caught by PyTest and makes traces involving
# pybind11 classes more readable. E.g. replace "<built-in method allclose
...
suffix_variants = [
    a + b
    for a in ["_mono", "_mono_polarized", "_rgb", "_spectral", "_spectral_polarized"]
    for b in ["", "_double"]
]
