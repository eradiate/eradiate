...
def square_to_uniform_disk_concentric(sample: ArrayLike):
    """
...
def square_to_uniform_hemisphere(sample: ArrayLike):
    """
...
def uniform_hemisphere_to_square(v: ArrayLike):
    """
    ...
    p = v[..., 0:2]
    return uniform_disk_to_square_concentric(p / np.sqrt(v[..., 2] + 1.0))


def uniform_disk_to_square_concentric(p: ArrayLike):
    """
