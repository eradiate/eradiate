"""
Heterogeneous atmospheres (legacy).
"""
...
@atmosphere_factory.register(type_id="heterogeneous_legacy")
@parse_docs
@attr.s
class HeterogeneousAtmosphereLegacy(Atmosphere):
    """
    Heterogeneous atmosphere scene element [``heterogeneous_legacy``].
    ...
    :class:`.HeterogeneousAtmosphereLegacy` are specified by a :class:`.RadProfile`
    object.
