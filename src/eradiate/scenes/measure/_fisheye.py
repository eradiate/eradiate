...
class FisheyeCameraMeasure(Measure):
    ...
    and the projection is published on the dataset attributes, see
    :meth:`dataset_attrs`.
    """
    ...
    projection_model: str = documented(
        ...
        doc="Projection model.",
        type="str",
        init_type='{"equidistant", "equisolid", "stereographic", '
        '"orthographic", "polynomial"}',
        default='"equisolid"',
    )
    ...
    def dataset_attrs(self) -> dict:
        """
        Return a description of the projection, published as global
        attributes of the result dataset.
    ...
    def update(self) -> None:
        ...
        if self.projection_model == "polynomial":
            ...
            raise ValueError(
                "'lens_coefficients' is only used by the 'polynomial' "
                "projection model, got "
